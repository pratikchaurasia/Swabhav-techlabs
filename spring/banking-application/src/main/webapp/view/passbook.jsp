...
<body>
	...
	<div>
		...
		<h1 align="center" class="jumbotron">
			Pass Book <i class="far fa-file-alt"></i>
		</h1>
	</div>
	<div class="col-md-4 container text-centered"
		...
		<s:form action="passbook">
			...
			<input type="radio" name="type" value="C" />Current<br>
			<input type="submit"
				class="btn btn-success" id="submit" value="Submit" >
		</s:form>
		<%
		...
		<div align="center">
			<input type="button" class="btn btn-primary btn-lg"
				value="Make a Transaction" onclick="location.href='transaction';"><br>
			<br>
			<button onclick="location.href='export';" class="btn btn-success">
